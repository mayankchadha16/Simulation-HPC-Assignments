...
/*
  BEGIN PARALLEL
  Because our parallel section extends over more than one FOR loop,
  we need to insert a pair of { } to delimit it.
*/
#pragma omp parallel private(i, j) shared(u, w) reduction(+ : diff)
        {
            /*
